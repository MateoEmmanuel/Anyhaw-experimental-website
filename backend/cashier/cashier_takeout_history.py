...
cashier_takeout_history_bp = Blueprint('cashier_takeout_history', __name__)

@cashier_takeout_history_bp.route('/cashier_takeout_history_loader')
def cashier_takeout_history_loader():
    ...
    try:
        ...
        return render_template('Cashier_take-out_history.html', orders=orders)

    except Exception as e:
        print("Error loading order queue:", e)
        return render_template('Cashier_take-out_history.html', orders=[])
